...
function Shop() {
  ...
  let getShop = async () => {
    let res = await MarketService.featuredSellerShop(id);
    if (res.status === 200) {
        ...
        <section className="market section_center">
          <div className="container-lg">
            <div
              ...
              {/* <div className="share"  onClick={shareShop} style={{cursor:"pointer"}}>
                <i
                  className="fa-solid fa-share-nodes"
                  style={{ fontSize: "20px", color: "#FFC700" }}
                ></i>
              </div>
              {/* ) : ( */}
              {/* <button
                ...
                style={{ width: "200px" }}
              >
                <i className="fa-solid fa-share-nodes pe-3"></i> {isShared ? 'Link shared!' : 'Share my shop'}
              </button> */}
              {/* )} */}
            </div>
